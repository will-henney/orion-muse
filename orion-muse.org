...
+ 
**** STARTED Make maps of the small-scale t2 
:PROPERTIES:
...
**** TODO [#C] Do extinction correction for all lines
...
for bin in 001 002 004 008 016 032 064 128 256; do
    python muse-Te-Ne-fuzz-histograms.py 000 $bin full
    python muse-Te-Ne-fuzz-histograms.py 001 $bin full
    python muse-Te-Ne-fuzz-histograms.py 000 $bin sweet
    python muse-Te-Ne-fuzz-histograms.py 001 $bin sweet
done
#+END_SRC
