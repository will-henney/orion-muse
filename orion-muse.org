...
|----------+-------+----------+----------+-----------+----------+------------------------------|
| O II     | P     |  4595.95 |        7 |         0 |        0 | ** blend 4596.18 + [Ni III]  |
...
| C II     | P     |  5342.40 |        6 |         1 |        1 | *** V17.06 pure recom        |
...
| N II     | P     | 5666.629 |        5 |         1 |        1 | multiplet 3                  |
...
| O I      | L     |  7773.37 |        1 |         1 |        5 | *** Mean 71.94,74.17,75.39   |
...
#+RESULTS:
#+begin_example
Mon Dec 26 00:06:45 GMT 2016
sending incremental file list
basic-line-list.tab

sent 575 bytes  received 82 bytes  23.05 bytes/sec
total size is 7,173  speedup is 10.92
sending incremental file list

sent 2,110 bytes  received 11 bytes  108.77 bytes/sec
total size is 144,236  speedup is 68.00
sending incremental file list

sent 169 bytes  received 11 bytes  6.55 bytes/sec
total size is 24,805,440  speedup is 137,808.00
#+end_example
